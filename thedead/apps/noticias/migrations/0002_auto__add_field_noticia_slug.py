...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Noticia.slug'
        db.add_column(u'noticias_noticia', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Noticia.slug'
        db.delete_column(u'noticias_noticia', 'slug')
    ...
    models = {
        ...
        u'noticias.noticia': {
            ...
            'titulo': ('django.db.models.fields.TextField', [], {'max_length': '64'})
        },
        u'usuarios.usuario': {
